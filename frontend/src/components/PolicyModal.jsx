...
function PrivacyContent() {
    return (
        <>
            ...
            <H2>四、同步功能說明</H2>
            <P>「同步校園資料」為<strong>完全自願的選擇性功能</strong>，需由您主動在「設定 → 同步校園資料」中操作。同步時，您輸入的帳號密碼依照第三條的零儲存政策處理；同步取回的課表、成績等資料<strong>僅存放於您的裝置本機</strong>（Web Storage / IndexedDB），不上傳至本應用程式的伺服器或任何第三方雲端服務。您可隨時透過「設定 → 登出」清除所有本機資料。</P>
            ...
            <H2>八、資料保留與刪除</H2>
            <P>本機資料：可隨時於「設定 → 登出」清除。意見回饋與共享平台內容：由管理員於後端雲端服務中管理，如需刪除請透過意見回饋功能聯繫。匿名分析事件：不含個人資訊，不提供個別刪除。</P>
